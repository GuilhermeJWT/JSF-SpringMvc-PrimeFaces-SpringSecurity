...
public class CampoConsultaConfig implements Serializable, Comparator<CampoConsultaConfig>{
	...
	@Override
	public int compare(CampoConsultaConfig o1, CampoConsultaConfig o2) {
		return ((CampoConsultaConfig)o1).getPrincipal().compareTo(((CampoConsultaConfig)o2).getPrincipal());
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CampoConsultaConfig other = (CampoConsultaConfig) obj;
		if (campoBanco == null) {
